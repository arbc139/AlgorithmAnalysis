...
public class AlgoHW2 {
	...
	static void findCrossingPoint() throws Exception {
		...
		for(int i=0; i<numberOfTestCase; i++) {
			...
			// HashMapping method
			HashMap<LineIngredient, ArrayList<Point>> lineHashMap = new HashMap<LineIngredient, ArrayList<Point>>();
	...
	static void findLineSegmentsHashMaping(ArrayList<Point> points, HashMap<LineIngredient, ArrayList<Point>> lineHashMap) {
